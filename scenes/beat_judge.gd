...
# The BeatJudge evaluates whether or not the player executed an action
# with the correct beat timing, and publishes events indicating things like
# "perfect", "early", "late", and "miss"
